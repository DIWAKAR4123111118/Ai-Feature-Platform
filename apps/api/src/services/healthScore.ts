...
export function calculateHealthScore(data: RepoHealthData): number {
  let score = 0;

  // Stars (0-40 points)
  if (data.stars !== null) {
    if (data.stars > 50000) score += 40;
    else if (data.stars > 10000) score += 30;
    else if (data.stars > 1000) score += 20;
